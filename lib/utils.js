...
export const isIT = (user) => {
  ...
  const emails = [
    ...
    'roger.sanjaume@somenergia.coop',
    'raul.carballo@somenergia.coop',
    'xavier.teres@somenergia.coop',
    'pau.boix@somenergia.coop'
  ]
...
export const isRRHH = (user) => {
  ...
  const emails = [
    'david.riera@somenergia.coop',
    'anna.rodon@somenergia.coop',
    'nuria.iglesias@somenergia.coop',
    'silvia.galia@somenergia.coop'
  ]
